...
const CartScreen = () => {
  ...
  let qty = new URLSearchParams(location.search);
  qty.get('qty');

  const cart = useSelector((state) => state.cart);
  const { cartItems } = cart;
  // console.log('tytutt', dispatch(getCartItems()));
useEffect(() => {
  
  console.log('get cart', dispatch(getCartItems()))
}, [dispatch])
  ...
  return (
    <main className='mx-auto max-w-2xl px-4 pt-14 pb-24 sm:px-6 lg:max-w-7xl lg:px-8'>
